...
with plt.style.context(['science']):
    ...
    fig2, axes2 = plt.subplots(4, 3, figsize = (21,17), constrained_layout=True)
    ...
    for j in range(len(dir_list)):
        ...
        img = axes2[j,0].scatter(a_prog, s_prog, c=cost_prog, cmap=cm.coolwarm, norm=nrm, s = 40)
        plt1 = axes2[j,0].plot(a_lis, s_lis, 'k-')
        img2 = axes2[j,1].scatter(s_prog, dB_prog, c=cost_prog, cmap=cm.coolwarm, norm=nrm, s = 40)
        img3 = axes2[j,2].scatter(a_prog, dB_prog, c=cost_prog, cmap=cm.coolwarm, norm=nrm, s = 40)
        imgerrors = axes2[j,0].scatter(besta, bests, color = 'fuchsia', s = 40)
        img2errors =  axes2[j,1].scatter(bests, bestdb, color = 'fuchsia', s = 40)
        img3errors = axes2[j,2].scatter(besta, bestdb, color = 'fuchsia', label = r'Fidelity $ > 0.97$ ', s = 40)
    ...
    fig2.savefig('figures/all_ns_views.png', dpi=400)
