...
#%%
t,cost_progress = runchain(newcost, np.sqrt(np.pi) * np.exp(1), 0.50, 0.01, 0.01)
#%%
np.save('anneal_4_0_0.5_1e4', t)
np.save('cost_prog_4,0,0.4,1e4', cost_progress)
#%%
t = np.load('anneal_4_0_0.5_1e4',allow_pickle=True)
cost_progress = np.load('cost_prog_4,0,0.4,1e4', allow_pickle=True)
